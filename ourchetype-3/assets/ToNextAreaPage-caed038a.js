import{_ as f,S as m}from"./PageContainer.vue_vue_type_style_index_0_lang-8d5a2e86.js";import{d as k,$ as a,e as b,f as x,r as l,U as w,o as d,k as p,w as _,u as t,b as i,t as g,h as y,g as B,W as I,X as j,p as N,a as P,_ as R}from"./base-bbb4a87e.js";import{r as z}from"./index-dcc955c4.js";import"./images-5702e0d1.js";import"./archetype-82cba3d4.js";const h=s=>(N("data-v-45e1464d"),s=s(),P(),s),C=h(()=>i("div",null,null,-1)),T=h(()=>i("div",{class:"divider"},null,-1)),Y=k({__name:"ToNextAreaPage",props:{area:{default:a.Persona}},setup(s){const v=s,c=b(),S=x(()=>!!c.bgSetting.bg);let n=l("/"),r=l(""),o=l(""),u=l(-1);const e={};switch(v.area){case a.Intro:n.value+=a.Persona+"/passcode",e.headerY=.5,e.logoSize=.5,r.value=`Menuju
