import{S as v,L as S}from"./LogoSet-8c8a8489.js";import{d as b,A as a,b as m,c as k,l as u,o as f,a as d,e as w,f as c,t as p,u as s,y as x,z as y,g,w as B,B as I,n as z,p as N,k as j,h as C,_ as P}from"./index-62b3cc2c.js";const T=t=>(N("data-v-4bec6da5"),t=t(),j(),t),A=T(()=>c("div",{class:"divider"},null,-1)),R=b({__name:"ToNextAreaPage",props:{area:{default:a.Persona}},setup(t){const _=t,i=m(),h=k(()=>!!i.bgSetting.bg);let o=u("/"),n=u(""),r=u(""),l=u(-1);const e={};switch(_.area){case a.Intro:o.value+=a.Persona+"/passcode",e.headerY=.5,e.logoSize=.5,n.value=`menuju
