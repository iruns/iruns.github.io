import{_ as f,S as w}from"./PageContainer.vue_vue_type_style_index_0_lang-75afac8b.js";import{e as x,u as y,f as l,r as i,a8 as o,a2 as B,k as p,w as _,g as a,o as g,d as u,t as h,i as I,h as N,a5 as j,a4 as z,p as C,b as M,_ as R}from"./progress-0ab57a67.js";import{n as T,r as Y}from"./index-0fdf0b30.js";const m=r=>(C("data-v-6d3081b7"),r=r(),M(),r),A=m(()=>u("div",null,null,-1)),P=m(()=>u("div",{class:"divider"},null,-1)),V=x({__name:"ToNextAreaPage",setup(r){const c=y(),v=T(),S=l(()=>!!c.bgSetting.bg);let t=i(""),n=i(""),s=i(-1);const d=l(()=>Y.currentRoute.value),k=l(()=>({name:v.pageFlows[d.value.name].next.page})),e={};switch(d.value.meta.area){case o.Intro:e.headerY=.5,e.logoSize=.5,t.value=`Silakan menuju
ke tempat pembelian
tiket
