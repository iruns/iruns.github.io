import{S as h,L as v}from"./LogoSet-c579857d.js";import{d as f,A as a,b as k,c as m,l as u,o as b,a as d,e as x,f as i,t as p,u as t,y as w,z as y,g,w as B,B as I,n as z,p as N,k as j,h as C,_ as P}from"./index-43830b47.js";const T=s=>(N("data-v-96da4ef2"),s=s(),j(),s),A=T(()=>i("div",{class:"divider"},null,-1)),R=f({__name:"ToNextAreaPage",props:{area:{default:a.Persona}},setup(s){const S=s,c=k(),_=m(()=>!!c.bgSetting.bg);let n=u("/"),o=u(""),r=u(""),l=u(-1);const e={};switch(S.area){case a.Intro:n.value+=a.Persona+"/passcode",e.headerY=.5,e.logoSize=.5,o.value=`Menuju
