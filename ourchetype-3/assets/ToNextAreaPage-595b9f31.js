import{_ as v,S as f}from"./PageContainer.vue_vue_type_style_index_0_lang-cda7bb06.js";import{d as k,a1 as a,e as b,f as w,r as u,W as x,o as d,m as p,w as _,u as t,b as i,t as m,h as y,g as B,Y as I,Z as N,p as j,a as Y,_ as z}from"./base-a8ea397d.js";import"./index-76f611f5.js";import"./images-5702e0d1.js";import"./archetype-82cba3d4.js";const g=n=>(j("data-v-0f8a23d1"),n=n(),Y(),n),C=g(()=>i("div",null,null,-1)),M=g(()=>i("div",{class:"divider"},null,-1)),P=k({__name:"ToNextAreaPage",props:{area:{default:a.Persona}},setup(n){const h=n,c=b(),S=w(()=>!!c.bgSetting.bg);let s=u({name:"welcome"}),r=u(""),o=u(""),l=u(-1);const e={};switch(h.area){case a.Intro:s.value.name="intro-to-next-area",e.headerY=.5,e.logoSize=.5,r.value=`Silakan menuju
ke tempat pembelian
tiket
